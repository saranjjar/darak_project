...
import 'package:darak_project/module/customer/main/home/search/search_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  final controllerNotification = Get.put(HomeController());
            ...
            Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      fontFamily: TextHelper.satoshiBold, fontSize: 18),
                ),
                Text(
            ...
            Obx(
              () => Stack(
                children: [
                  IconButton(
                      onPressed: () {
                        Get.off(NotificationsScreen(),
                                arguments:
                                    controllerNotification.notification.value)
                            ?.then((value) =>
                                controllerNotification.notification.clear());
                      },
                      icon: Container(
                          decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border:
                                  Border.all(color: ColorHelper.offWhiteColor)),
                          child: const Padding(
                  ...
                  controllerNotification.notification.isNotEmpty
                      ? Container(
                          ...
                          child: Obx(
                            () => Text(
                              '${controllerNotification.notification.length}',
          ...
          child: GridView.count(
            ...
            children: List.generate(
                ...
                (index) => _controller.isLoading
                    ...
                    : InkWell(
                        onTap: () {
                          _controllerCategory.getSubcategoriesInCategory(
                              controller.categoryList[index].id);
                          print(controller.categoryList[index]
                              .data()
                              .serviceName!);
                          Get.toNamed(Routes.categoriesRoutes, parameters: {
                            "service_name": controller.categoryList[index]
                                .data()
                                .serviceName!,
                          });
                        },
                        child: _buildGridItem(
                            controller.categoryList[index], icon[index]),
                      )),
          ),
        )
      ]),
