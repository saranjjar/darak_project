...
class BookDetailsScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Obx(
                        () => Text(
                          _controller.workingHours.value.toString(),
                          style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: D_MaterialButton(
                          onPressed: () {
                            if (_controller.finalPrice.value
                                    .toString()
                                    .isNotEmpty &&
                                ...
                                _controller.selectedDate.value
                                    .toString()
                                    .isNotEmpty &&
                                _controller.workingHours.value
                                    .toString()
                                    .isNotEmpty) {
                              Get.toNamed(Routes.locationRoutes);
                            } else {
  ...
  TextStyle _buildTextStyle() =>
      TextStyle(fontSize: 16, fontFamily: TextHelper.satoshiBold);
